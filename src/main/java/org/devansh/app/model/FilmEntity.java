...
public class FilmEntity {
    ...
    public FilmEntity(){}
    public FilmEntity(short filmId , String tite , short length){
        this.filmId = filmId;
        this.title = tite;
        this.length = length;
    }
    ...
    @Basic
    @Column(name = "special_features" , columnDefinition = "set('Trailers', 'Commentaries' ,'Deleted Scenes' ,'Behing the Scenes')")
